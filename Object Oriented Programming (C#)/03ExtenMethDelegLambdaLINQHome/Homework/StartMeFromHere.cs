...
1 + 1/2 - 1/4 + 1/8 - 1/16 + …*/
            ...
            //////////////////////////////////
            /// 
            Console.WriteLine(Environment.NewLine + "P.S." + Environment.NewLine +
                "Sorry - didn't have time to arrange classes in folders and" + Environment.NewLine +
                "some of logics can be put in separated classes." + Environment.NewLine + 
                "I'm going to sleep now! z Z Z");
